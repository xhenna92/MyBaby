...
- (void)setupYALTabBarController {
    ...
    YALTabBarItem *item1 = [[YALTabBarItem alloc] initWithItemImage:[UIImage imageNamed:@"kids_tab_icon"]
                                                      leftItemImage:[UIImage imageNamed:@"kids_tab_icon"]
                                                     rightItemImage:nil];
    
    
    
    YALTabBarItem *item2 = [[YALTabBarItem alloc] initWithItemImage:[UIImage imageNamed:@"how_to_tab_icon"]
                                                      leftItemImage:[UIImage imageNamed:@"how_to_tab_icon"]
                                                     rightItemImage:nil];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "nyc.c4q.xhenna92.My_Baby" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"My_Baby" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"My_Baby.sqlite"];
    NSError *error = nil;
